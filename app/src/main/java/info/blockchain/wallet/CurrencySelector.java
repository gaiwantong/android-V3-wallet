...
//        String[] blockchain_currencies = CurrencyExchange.getInstance(this).getBlockchainCurrencies();
        String strFiatCode = PrefsUtil.getInstance(CurrencySelector.this).getValue("ccurrency", "USD");
//        OtherCurrencyExchange.getInstance(this, blockchain_currencies, strFiatCode);
        ...
        bOK.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
	            ...
	            PrefsUtil.getInstance(CurrencySelector.this).setValue("ccurrency", currencies[currency].substring(currencies[currency].length() - 3));
            	finish();
            }
        });
    ...
    private void initValues() {
        String strCurrency = PrefsUtil.getInstance(CurrencySelector.this).getValue("ccurrency", "USD");
    	int sel = -1;
