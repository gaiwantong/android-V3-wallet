...
//        String[] blockchain_currencies = CurrencyExchange.getInstance(this).getBlockchainCurrencies();
        String strFiatCode = PrefsUtil.getInstance(CurrencySelector.this).getValue(PrefsUtil.KEY_SELECTED_FIAT, "USD");
//        OtherCurrencyExchange.getInstance(this, blockchain_currencies, strFiatCode);
    ...
    private void initValues() {
        String strCurrency = PrefsUtil.getInstance(CurrencySelector.this).getValue(PrefsUtil.KEY_SELECTED_FIAT, "USD");
    	int sel = -1;
